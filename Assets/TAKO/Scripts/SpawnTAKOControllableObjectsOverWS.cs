...
public class SpawnTAKOControllableObjectsOverWS : MonoBehaviour
{
    public static SpawnTAKOControllableObjectsOverWS instance;
    ...
    void Start()
    {
        ...
        io.On("blueScore", (SocketIOEvent e) =>
        {
            Debug.Log("SocketIO blueScore");
        });
